...
if (isset($category->term_id)) {
  ...
  $headingtxt_color = get_term_meta($category->term_id, 'category_page_filter_title_color', true);
  ?>
  ...
  <style>
      .caption-wrapper{
          background-color:<?php echo $bg_color; ?>;color:<?php echo $txt_color; ?>
      }
      .left-filter{
          background-color:<?php echo $bg_color; ?>;
      }
      .search-side-product .woocommerce-products-header h2,.woof_container_inner h4{
          color: <?php echo $headingtxt_color;?>
      }
      @media (min-width: 991.98px) {
          ...
          .left-filter input[type=checkbox]:checked {
...
<?php } ?>
  ...
  <div class="item-wrapper" style="background-color:<?php echo $bg_color; ?>;color:<?php echo $txt_color; ?>">
