...
<div class="cart-page-wrapper">
  ...
  <div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-4 cart__class_new">
...
?>
'label'         => '<span class="woocommerce-terms-and-conditions-checkbox-text">'.esc_html__("The user consents to the use of data. More information:","textdomain").' <a href="'.esc_html__("/privacy-policy/","textdomain").'" class="woocommerce-terms-and-conditions-link" target="_blank">'.esc_html__("Privacy Policy","textdomain").'</a>. </span>',